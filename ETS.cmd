...
echo 6. Flush ARP Cache         
echo 7. Delete Browser Cookies and Cache                                                  
echo 8. Delete Windows Error Reports         
echo 9. Reset Windows Explorer               
echo 10.Reset All Network Adapters           
echo 11.Reset Network Settings                
echo 12.Reset Task Scheduler                       
echo 13.Optimize System Drives (Defragmentation) 
echo 14.Run Disk Cleanup                         
echo 15.Monitor System Performance               
echo 16.Manage Startup Programs                     
echo 17.Disable Unnecessary Services                                          
echo 18.Restart Print Spooler Service                                              
echo 19.Lock/Unlock USB Ports                                          
echo 20.Show Wi-Fi Passwords (Current Network)                                           
echo 21.Export System Information                                            
echo 22.Check Internet Speed                                           
echo 23.Advanced Options                                            
echo =============================================================================
echo 0. Exit
echo =============================================================================
